      ...
      <div className="max-w-[1200px] mx-auto px-5 py-16 pb-24">
        ...
        <div className="glass-panel mb-12 p-8">
          ...
          <div className="relative w-full mb-6">
            ...
            <input
              ...
              className="w-full bg-black/25 border border-white/10 py-4 pr-4 pl-12 rounded-xl text-white outline-none text-base transition-colors duration-200 focus:border-accent"
            />
          </div>
                  ...
                  {items.slice(0, visibleCount).map((item, idx) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="glass-panel flex flex-col justify-between min-h-[230px] relative overflow-hidden p-6"
                        style={{
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center mt-auto pt-3 border-t border-white/5">
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 text-white no-underline text-sm font-semibold transition-colors"
        ...
        {Object.values(groupedResources).some(arr => arr.length > visibleCount) && (
          <div className="flex justify-center mb-20">
            <button
              ...
              className="bg-white/5 border border-white/10 text-white py-4 px-12 rounded-full text-base font-semibold cursor-pointer transition-all hover:bg-white/10 hover:border-white/20"
            >
              {t('vaultLoadMore')}
            </button>
          </div>
        ...
        {filteredResources.length === 0 && (
          <div className="text-center py-16 border border-dashed border-white/10 rounded-2xl mb-20">
            <HelpCircle size={48} className="text-gray-400 mx-auto mb-4 opacity-50" />
        ...
        {/* CTA Loop */}
        <section className="glass-panel p-12 bg-[radial-gradient(circle_at_10%_20%,rgba(20,184,166,0.15)_0%,rgba(139,92,246,0.05)_100%)] border border-white/10 rounded-[24px] text-center">
