...
import { Globe, ShieldCheck, TrendingUp, BrainCircuit, Activity, AlertTriangle, Mail, Phone, MapPin, ArrowRight } from 'lucide-react';
  ...
  return (
    <motion.div initial="initial" animate="in" exit="out" variants={pageVariants} transition={{ duration: 0.4 }}>
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 pb-10">
        ...
        {/* Footer */}
        <footer className="glass-panel flex flex-col gap-8 border-t border-white/10">
