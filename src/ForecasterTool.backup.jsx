      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-8">
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <input type="range" min="1000" max="200000" step="1000" value={traffic} onChange={(e) => setTraffic(Number(e.target.value))} />
          </div>
          <div>
            <div className="flex justify-between mb-2">
            ...
            <input type="range" min="0.1" max="10" step="0.1" value={cvr} onChange={(e) => setCvr(Number(e.target.value))} />
          </div>
          <div>
            <div className="flex justify-between mb-2">
            ...
            <input type="range" min="10" max="500" step="5" value={aov} onChange={(e) => setAov(Number(e.target.value))} />
          </div>
          <div>
            <div className="flex justify-between mb-2">
            ...
            <input type="range" min="1000" max="50000" step="1000" value={spend} onChange={(e) => setSpend(Number(e.target.value))} />
          </div>
        </div>
